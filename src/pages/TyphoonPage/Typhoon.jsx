			 ...
			 <main className={classes.main}>
				 <section className={classes.tornado_block}>
					 ...
					 <div className={classes.tornado_subtitle}>
						 <p>
							 Мобильный робототехнический комплекс (МРК) «Тайфун» состоит из «Колесно-шагающего» транспортного
							 средства, телевизионной (тепло-телевизионной) системы видеонаблюдения, пульта дистанционного
							 управления, манипулятора и/или другого дополнительного оборудования.
						 </p>
					 </div>
