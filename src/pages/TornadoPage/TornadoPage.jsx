		 ...
		 <main className={classes.main}>
			 <section className={classes.tornado_block}>
				 ...
				 <div className={classes.tornado_subtitle}>
					 <p>Мобильный робот специального назначения «Торнадо»
						 создан для выполнения задач, которые опасны для жизни и здоровья человека.
						 Он спроектирован с учетом ключевых требований и пожеланий наших клиентов,
						 изготовлен из высококачественных материалов,
						 что делает его функциональным, надежным и долговечным помощником.</p>
				 </div>
