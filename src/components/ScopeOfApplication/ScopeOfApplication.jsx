			...
			<div className={classes.block_widgets}>
					 ...
					 <div className={classes.widget_left}>
						 ...
						 <div className={classes.widgets_title_left}>
							 ...
							 <p>Роботы представляют из себя прочную конструкцию и не рискуют жизнью при работе в хлипких конструкциях</p>
						 </div>
					 </div>	
					 <div className={classes.widget_right}>
						 <div className={classes.widgets_title_right}>
							 <h2>Визуальная/Радиационная/Инженерная разведка</h2>
							 <p>Поворотные камеры с большим оптическим увеличением или тепловизионным изображением, различные типы датчиков и сенсоров позволяют адаптировать робота под любую задачу </p>
						 </div>
						 <img className={classes.img} src={icons6} alt=""/>
					 </div>
					 <div className={classes.widget_left}>
						 ...
						 <div className={classes.widgets_title_left}>
							 ...
							 <p>У вас химическое предприятие с большой территорией? Запустите,оснащенного необходимым набором сенсоров, робота контролировать периметр и он выполнит подготовленный набор инструкций в случае утечки или аварии </p>
						 </div>
					 </div>	
					 ...
					 <div className={classes.widget_right}>
						 <div className={classes.widgets_title_right}>
							 ...
							 <p>Есть задача построить точную 3д карту местности, туннеля или шахты? Робот сможет сделать это в  автоматическом режиме без перерыва на обед или исключить риски здоровью оператору при ручном управлении в небезопасных местах </p>
						 </div>
					 ...
					 <div className={classes.widget_left}>
						 ...
						 <div className={classes.widgets_title_left}>
							 ...
							 <p>Способность гибкой модификации системы позволяет настроить робота под уникальные задачи вашей территории, автоматизировать или дистанцировать необходимые процессы.</p>
						 </div>
					 </div>	
					 <div className={classes.widget_right}>
						 <div className={classes.widgets_title_right}>
							 <h2>Разминирование</h2>
							 <p>Дистанционное управление по радио или кабелю позволяет исключить риски при столь опасной работе, а бесчисленный список доп. оснащения еще и ускорит этот процесс  </p>
						 </div>
